...
import 'package:cleversell_booking/screens/cash_in_screen.dart';
...
final List<GetPage> routes = [
  ...
  GetPage(name: settingsRoute, page: () => SettingsScreen(SettingsController(_branchRepository))),
  ...
  GetPage(name: cashInRoute, page: () => CashInScreen(CashInController(_cashInRepository))),
