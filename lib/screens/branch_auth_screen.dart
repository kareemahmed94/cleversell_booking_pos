...
class BranchAuthScreen extends StatelessWidget {
  final BranchAuthController controller;

  const BranchAuthScreen(this.controller, {super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<BranchAuthController>(
        init: controller,
