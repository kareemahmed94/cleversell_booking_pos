...
class CheckOutsScreen extends StatelessWidget {
  ...
  const CheckOutsScreen(this.controller, {super.key});
            ...
            children: [
              IconButton(
                ...
                icon: Icon(
                  ...
                  color: controller.page - 1 != 0 &&
                      controller.allCheckOuts.isNotEmpty
                      ? highlight
                      : primaryDim,
                ),
              ...
              SizedBox(
                ...
                child: controller.loading == false
                  ...
                  rows: controller.checkOuts.isNotEmpty
                      ? controller.checkOuts.map<DataRow>((checkOut) {
                    var w = DataRow(
                      cells: <DataCell>[
                        const DataCell(Icon(
                            Icons.remove_red_eye_outlined,
                            color: highlight)),
                        DataCell(Text(checkOut.id,
                            style: const TextStyle(
                                color: primary,
                                fontSize: 16.0,
                                fontWeight: FontWeight.w400))),
                        DataCell(Text('${checkOut.customerName}',
                            style: const TextStyle(
                                color: primary,
                                fontSize: 16.0,
                                fontWeight: FontWeight.w400))),
                        DataCell(Text(checkOut.customerPhone,
                            style: const TextStyle(
                                color: primary,
                                fontSize: 16.0,
                                fontWeight: FontWeight.w400))),
                        DataCell(Text(checkOut.productName,
                            style: const TextStyle(
                                color: primary,
                                fontSize: 16.0,
                                fontWeight: FontWeight.w400))),
                        DataCell(Text(
                            ...
                            style: const TextStyle(
                                ...
                                fontSize: 16.0,
                                fontWeight: FontWeight.w400))),
                        DataCell(Text('${checkOut.roomName}',
                            style: const TextStyle(
                                color: primary,
                                fontSize: 16.0,
                                fontWeight: FontWeight.w400))),
                    ...
                    : const Center(
                  child: Text(
                    "No CheckOuts found in this timespan",
                    style: TextStyle(
                        color: highlight,
                        fontSize: 25,
